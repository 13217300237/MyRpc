...
import study.hank.com.client2.business.IUserBusiness;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Class<? extends IpcService> targetServiceClz = IpcService.IpcService1.class;

    private String userName = "zhou";
    private String password = "zzzzzz";
